...
# [MISE] description="replace all the tab characters with the specified number of spaces"
# [USAGE] flag "-w --whitespaces-count <number>" help="number of whitespaces to substitute tabs with" default="4"
# [USAGE] arg "[files]" var=#true help="files in which to replace tabs with spaces"
